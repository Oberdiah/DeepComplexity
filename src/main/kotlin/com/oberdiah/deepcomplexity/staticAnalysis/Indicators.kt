...
sealed class Indicator<T : Any>(val clazz: KClass<T>) {
    ...
    abstract fun newVarianceRepresentingOneOf(key: EvaluationKey<*>): Variances<T>
...
sealed class NumberIndicator<T : Number>(clazz: KClass<T>) : Indicator<T>(clazz) {
    ...
    override fun newVarianceRepresentingOneOf(key: EvaluationKey<*>): Variances<T> =
...
data object BooleanIndicator : Indicator<Boolean>(Boolean::class) {
    override fun newVarianceRepresentingOneOf(key: EvaluationKey<*>): Variances<Boolean> =
...
data class ObjectIndicator(val type: MyPsiType) : Indicator<HeapMarker>(HeapMarker::class) {
    ...
    override fun newVarianceRepresentingOneOf(key: EvaluationKey<*>): Variances<HeapMarker> =
...
object VarsIndicator : Indicator<VarsMarker>(VarsMarker::class) {
    ...
    override fun newVarianceRepresentingOneOf(key: EvaluationKey<*>): Variances<VarsMarker> = WONT_IMPLEMENT()
}