...
data class Bundle<T : Any> private constructor(
    ...
    data class ConstrainedVariances<T : Any> private constructor(
        ...
        fun toDebugString(): String {
            ...
            val varsTracking = variances.varsTracking()
            val constraintsToPrint = constraints.constraints.entries
                .filter { !varsTracking.contains(it.key) }
                .filter { !it.key.isAutogenerated() }
            ...
            val collapsed = variances.collapse(constraints)
            return "($collapsed = $variancesStr | $constraintsStr)"
        }
    }
