...
abstract class AbstractSet<Self : AbstractSet<Self, PureSet>, PureSet>(
    ...
    val elements: List<ConstrainedSet<PureSet>> = elements.map { ConstrainedSet(emptyMap(), it) }

    data class ConstrainedSet<PureSet>(val constraints: Map<Context.Key, Set<*>>, val set: PureSet)
