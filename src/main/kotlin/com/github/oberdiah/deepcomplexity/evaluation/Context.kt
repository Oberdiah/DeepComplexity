...
class Context private constructor(
    ...
    sealed class Key {
        ...
        fun canBeResolvedWithThis(): Boolean = this is QualifiedKey && this.qualifier == Heap.This
    ...
    fun resolveThis(thisObj: Expr<*>?): Context {
        ...
        for ((key, expr) in variables) {
            ...
            val rValue = expr.replaceTypeInTree<VariableExpression<*>> { varExpr ->
                if (varExpr.key.canBeResolvedWithThis()) {
                    thisObj.getField(newContext, (varExpr.key as Key.QualifiedKey).field)
                } else {
                    null
                }
