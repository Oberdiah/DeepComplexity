...
object ExprEvaluate {
    fun <T : ConstrainedSetCollection<T>> evaluate(expr: IExpr<T>, condition: IExpr<BooleanSet>): T {
    ...
    private fun <T : ConstrainedSetCollection<T>> evaluateAnythings(expr: IExpr<T>, condition: IExpr<BooleanSet>): T {
        return when (expr) {
