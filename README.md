...
to update correctly.
To resolve this, delete the `.intellijPlatform` and `.build` folders, then run `./gradlew clean build --rerun-tasks`.
...
- Manually:
  ...
  Download the [latest release](https://github.com/Oberdiah/DeepComplexity/releases/latest) and install it manually
  using
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>⚙️</kbd> > <kbd>Install plugin from disk...</kbd>
